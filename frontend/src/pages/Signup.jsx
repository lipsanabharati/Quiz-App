        ...
        <main className="min-h-screen bg-white flex flex-col justify-between font-sans relative overflow-hidden">
            ...
            <header className="p-6 border-b border-gray-100 bg-white/50 backdrop-blur-sm">
                <nav className="max-w-6xl mx-auto flex justify-between items-center">
                    ...
                    <Link to='/login' className="px-6 py-2 border-2 border-indigo-600 text-indigo-600 rounded-xl font-bold hover:bg-indigo-50 transition-all active:scale-95">
                        Login
                    </Link>
                </nav>
            </header>
            ...
            <section className="flex flex-col items-center px-4 py-12">
                <div className="bg-white p-10 rounded-3xl shadow-xl shadow-indigo-100/50 w-full max-w-md border border-gray-100">
                    ...
                    <p className="text-gray-500 text-center mb-8 font-medium">Please enter your details to sign up</p>

                    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                        <div className="flex flex-col gap-1.5">
                            <label htmlFor="uname" className="text-sm font-bold text-gray-700 ml-1">Username</label>
                            <input 
                                type="text" 
                                id='uname' 
